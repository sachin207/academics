...
<html>
	...
	<body>
		...
		?>
		<h1 class="heading">You have <?php echo $number==0?"no":"the following"; ?> past bookings.</h1>
		<?php
			if($number==0)
				goto skip_table;
			echo "<center>
		...
		?>
		<br/>
		<center><a href="delete_past_bookings.php">Click here to delete all your past bookings</a></center><br/>
		<?php skip_table: ?>
		<center><a href="my_bookings.php">Click here to see your current bookings</a></center>
	</div>
	</body>
</html>