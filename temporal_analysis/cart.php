...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || Dummy Ecommerce Portal</title>
      ...
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            $result = $mysqli->query('SELECT prodId, product_name, qty, price FROM camera_product WHERE prodId = "'.$product_id.'"');
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; Dummy Ecommerce Portal. All Rights Reserved.</p>
        </footer>
